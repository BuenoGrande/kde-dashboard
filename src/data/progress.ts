...
export const speakingChecklist: SpeakingItem[] = [
  ...
  },
  {
    ...
    status: "needs_review",
    note: "Phone-picture attempt with Denajder added concrete position/detail practice; still needs a full 5-minute structure with choice, opinion, follow-ups and no English/French.",
  },
  {
